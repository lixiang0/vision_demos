...
from models.pointnet2_cls import PointNet2MSGCls,Loss
import numpy as np
...
is_cuda=True
use_checkpoint=True
PRE_TRAIN_PATH='checkpoints/pointnet2_msg/cls'
TRAIN_EPOCH=300
BEST_ACC=0
MODEL_PATH='checkpoints/pointnet2_msg/cls'
model=PointNet2MSGCls()
